...
import { internal } from "./_generated/api";
 ...
 export const getEventDashboard = query({
    ...
    handler: async (ctx , args)=>{
        ...
        const identity = await ctx.auth.getUserIdentity(); // here identity is same as user._id
        ...
        // Calculate stats
        const totalRegistrations = registrations.filter((r)=> r.status === "confirmed")
        .length;
        ...
        const checkedInRate = totalRegistrations > 0 ?
