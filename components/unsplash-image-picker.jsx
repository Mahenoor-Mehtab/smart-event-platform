...
className='realtive aspect-video overlow-hidden rounded-lg border-2 border-transparent hover:border-purple-500 transition-all'
>
    <Image
    src={image.urls.small}
    alt={image.description || "Unspalsh image"}
